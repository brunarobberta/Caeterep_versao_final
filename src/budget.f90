...
contains
   ...
   subroutine daily_budget(dt, w1, w2, ts, temp, prec, n_days, stored_seed_bank, p0, ipar, rh&
        ...
        &, height_aux, seed_mass_out_budg, npp_pft)
...
!     ----------------------------INPUTS-------------------------------
      ...
      real(r_8),dimension(npls),intent(out) ::  seed_bank_out_bdgt, height_aux, seed_mass_out_budg, npp_pft!! NEW (module_reproduction)
